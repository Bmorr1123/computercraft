...
args[4] = args[4].."/"..args[1].."_"..args[2]
print("Saving to:", args[4])
...
os.loadAPI("/disk/file_server/json")
if not json then
...
function retrieve()
preset.start()
local data = "https://api.github.com/repos/"..args[1].."/"..args[2].."/git/trees/"..args[3].."?recursive=1"
print(data)
data = json.decode(http.get(data).readAll())
